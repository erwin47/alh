...
CListHeaderEditDlg::CListHeaderEditDlg(wxWindow *parent, const char * szWorkKey)
              :CResizableDlg( parent, wxT("Edit list column set"), SZ_SECT_WND_LST_COLEDIT_DLG)//, wxDEFAULT_DIALOG_STYLE)
{
    wxBoxSizer   * topsizer;
    wxBoxSizer   * rowsizer;
    wxBoxSizer   * colsizer;
...
void  CListHeaderEditDlg::OnSetNameChange(wxCommandEvent& )
{
    if (m_IsSaving)
        return;
...
void  CListHeaderEditDlg::OnSetNameSelect(wxCommandEvent& )
{
    if (m_IsSaving)
        return;
