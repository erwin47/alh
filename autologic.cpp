    ...
    bool evaluate_statement(CLand* land, CUnit* unit, const std::string& statement, std::vector<unit_control::UnitError>& errors)
    {
        ...
        switch(command) 
        {
            ...
            case Command::UNIT_ITEM: {
                ...
                errors.push_back({"Debug", unit, nullptr, "Item ("+code+") amount: "+std::to_string(item_amount) + 
            ...
            case Command::REGION_SELL: {
                errors.push_back({"Debug", unit, nullptr, "Command was evaluated as Command::REGION_SELL"});
            ...
            case Command::REGION_WANTED: {
                    errors.push_back({"Debug", unit, nullptr, "Command was evaluated as Command::REGION_WANTED"});        
