...
enum
{
    ...
    menu_Popup_ScoutSimple  ,
    menu_Popup_ScoutMove    ,
    menu_Popup_ScoutObserver,
    menu_Popup_ScoutStealth ,
    menu_Popup_ScoutGuard   ,
...
#define SZ_KEY_FIRST_SHIP_NUMBER         "FIRST_SHIP_NUMBER"
#define SZ_KEY_MOVEMEMENT_SPEED_WALK     "MOVEMENT_SPEED_WALK"
#define SZ_KEY_MOVEMEMENT_SPEED_RIDE     "MOVEMENT_SPEED_RIDE"
#define SZ_KEY_MOVEMEMENT_SPEED_FLY      "MOVEMENT_SPEED_FLY"
